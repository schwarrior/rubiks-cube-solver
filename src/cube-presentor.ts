...
export class CubePresentor {
    ...
    static getConsoleRepresentation = (cube: Cube) : string => {
        ...
        const r3 = `${cube.left.topLeft}${cube.left.top}${cube.left.topRight}${cube.front.topLeft}${cube.front.top}${cube.front.topRight}${cube.right.topLeft}${cube.right.top}${cube.right.topRight}  ${cube.back.topLeft}${cube.back.top}${cube.back.topRight}`
        const r4 = `${cube.left.left}${cube.left.center}${cube.left.right}${cube.front.left}${cube.front.center}${cube.front.right}${cube.right.left}${cube.right.center}${cube.right.right}  ${cube.back.left}${cube.back.center}${cube.back.right}`
        const r5 = `${cube.left.bottomLeft}${cube.left.bottom}${cube.left.bottomRight}${cube.front.bottomLeft}${cube.front.bottom}${cube.front.bottomRight}${cube.right.bottomLeft}${cube.right.bottom}${cube.right.bottomRight}  ${cube.back.bottomLeft}${cube.back.bottom}${cube.back.bottomRight}`
